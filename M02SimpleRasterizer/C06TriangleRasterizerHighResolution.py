...
fb = FrameBuffer(16 * SCALING_FACTOR, 8 * SCALING_FACTOR)
...
def DrawTriangleVecList(vecList, color):
    v0 = Vec2(vecList[0][0] * SCALING_FACTOR, vecList[0][1] * SCALING_FACTOR)
    v1 = Vec2(vecList[1][0] * SCALING_FACTOR, vecList[1][1] * SCALING_FACTOR)
    v2 = Vec2(vecList[2][0] * SCALING_FACTOR, vecList[2][1] * SCALING_FACTOR)
